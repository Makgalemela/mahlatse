...
import com.cloud.ibm.util.ObjectSerializer;
...
public class JwtAuthorizationFilter extends BasicAuthenticationFilter {
    ...
    boolean responseObject(String message, Integer status, boolean isSuccess, JSONObject json,
        ...
        json.put(AppConstant.TIMESTAMP, new Date().getTime());
        json.put(AppConstant.STATUS, status);
        json.put(AppConstant.IS_SUCCESS, isSuccess);
        json.put(AppConstant.MESSAGE, message);
